...
> **À Quai** — version `3.53.0`. La même version se **promeut** de `dev` (développement) à `preprod` (préproduction) puis à `prod` (production) : l'environnement d'un serveur est défini par son script de déploiement, pas par les fichiers.
...
**Version :** `3.53.0` | **Stack :** Flask · SQLite · Vanilla JS | **Licence :** usage interne  
