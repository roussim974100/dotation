...
> ⚠️ **Branche de développement (`dev`)** — version `3.18.6-dev`, non destinée à la production.
...
**Version :** `3.18.6-dev` | **Stack :** Flask · SQLite · Vanilla JS | **Licence :** usage interne  
**Statut :** Développement 🛠️ | **Dernière MAJ :** 17 septembre 2026
