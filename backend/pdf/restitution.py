    ...
    sections = [
        (
            ...
            [
                ...
                f"Date de fin de mission : {format_export_datetime(restitution.get('missionEndAt'))}",
                f"Date de restitution du matériel : {format_export_datetime(restitution.get('returnedAt'))}",
