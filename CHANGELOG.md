...
- **Base squelette** : `python scripts/build_skeleton.py aquai_diagnostic.zip dossier` reconstruit une base synthétique (mêmes ressources, mêmes champs, volumes et anomalies comparables, données fictives) pour reproduire un problème chez soi.
